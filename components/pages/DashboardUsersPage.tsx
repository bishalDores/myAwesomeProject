        ...
        <div className="overflow-x-auto">
          <div className="inline-block min-w-full overflow-hidden">
            <table className="min-w-full leading-normal">
              ...
              <tbody>
                <tr>
                  <td className="px-5 py-5 bg-white text-[#4E5D78] text-[14px] font-semibold text-center">1</td>
                  <td className="px-5 py-5 bg-white text-sm">
                    <div className="flex items-center">
                      <div className="flex-shrink-0 ">
                        <Image src={"/images/user.png"} className="rounded-[15px]" width={60} height={60} alt={"user image"} />
                      </div>
                      <div className="ml-3">
                        <p className="text-[#4E5D78] text-[14px] font-semibold whitespace-no-wrap">Michael Lawson</p>
                      </div>
                    </div>
                  </td>
                  <td className="px-5 py-5 bg-white text-sm">
                    <p className="text-[#4E5D78] text-[14px] font-semibold">michael.lawson@reqres.in</p>
                  </td>
                  <td className="px-5 py-5  bg-white text-sm">
